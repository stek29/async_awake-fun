// xcrun -sdk iphoneos gcc -arch arm64 -framework Foundation -o inject_launchd inject_launchd.m
// jtool --sign --inplace --ent ent.plist inject_launchd

/* code comes from IB's triple_fetch inject_launchd.c */
